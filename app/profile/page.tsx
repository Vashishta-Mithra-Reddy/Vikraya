...
const ProfilePage = () => {
  ...
  return (
    <div className="flex flex-col items-start justify-start min-h-screen text-black p-6 mt-10 wrapper">
      <h1 className="text-4xl font-bold mb-12">Your Auctions</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full animate-in slide-in-from-bottom-16 duration-700 fade-in-80">
